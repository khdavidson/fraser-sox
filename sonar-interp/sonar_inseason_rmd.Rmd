...
# This script was brought to you by K. Davidson and D. Couture in May 2021.
...
# Before running this RMarkdown, in a separate R script do: 
# 1. run    tinytex::install_tinytex()
# 2. run    library(tinytex)
# This will install a package to create a PDF output from R. You only have to do this one time per computer, and then never do it again!
...
project.name <- as.vector(colnames(read_excel("Stellako_Sonar_tool_2020.xlsm", sheet="Data entry", range="E1:E1")))
